...
public class Module {
    ...
    @ToMany(referencedJoinProperty = "moduleId")
    List<Note> noteList;
    ...
    @Generated(hash = 1158677702)
    private transient ModuleDao myDao;

    @Generated(hash = 1251965584)
    public Module(Long id, String name, String createAt) {
        this.id = id;
        this.name = name;
    ...
    public List<Note> getNoteList() {
        if (noteList == null) {
            ...
            List<Note> noteListNew = targetDao._queryModule_NoteList(id);
            synchronized (this) {
                if (noteList == null) {
